void tick() {
    ...
    emitters[0].radius = 0.065;
    emitters[0].color = vec3(1.0, 0.25, 0.05);
    emitters[0].velocity = 0.08;
    ...
    emitters[1].radius = 0.06;
    emitters[1].color = vec3(0.05, 0.45, 1.0);
    emitters[1].velocity = 0.06;
    ...
    emitters[2].radius = 0.055 + breathe * 0.02;
    emitters[2].color = vec3(0.1, 1.0, 0.25);
    emitters[2].velocity = 0.05;
