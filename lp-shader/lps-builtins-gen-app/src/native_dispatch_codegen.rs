...
fn guest_pointer_out_plan(fn_name: &str) -> Option<Vec<(usize, usize, &'static str)>> {
    match fn_name {
        "__lp_lpfx_hsv2rgb_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_hsv2rgb_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_hsv2rgb_vec4_f32" => Some(vec![(0, 4, "f32")]),
        "__lp_lpfx_hsv2rgb_vec4_q32" => Some(vec![(0, 4, "i32")]),
        "__lp_lpfx_hue2rgb_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_hue2rgb_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_rgb2hsv_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_rgb2hsv_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_rgb2hsv_vec4_f32" => Some(vec![(0, 4, "f32")]),
        "__lp_lpfx_rgb2hsv_vec4_q32" => Some(vec![(0, 4, "i32")]),
        "__lp_lpfx_saturate_vec3_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_saturate_vec3_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_saturate_vec4_f32" => Some(vec![(0, 4, "f32")]),
        "__lp_lpfx_saturate_vec4_q32" => Some(vec![(0, 4, "i32")]),
        "__lp_lpfx_srandom3_vec_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_srandom3_vec_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_srandom3_tile_f32" => Some(vec![(0, 3, "f32")]),
        "__lp_lpfx_srandom3_tile_q32" => Some(vec![(0, 3, "i32")]),
        "__lp_lpfx_psrdnoise2_f32" => Some(vec![(5, 2, "f32")]),
        "__lp_lpfx_psrdnoise2_q32" => Some(vec![(5, 2, "i32")]),
        "__lp_lpfx_psrdnoise3_f32" => Some(vec![(7, 3, "f32")]),
        "__lp_lpfx_psrdnoise3_q32" => Some(vec![(7, 3, "i32")]),
        _ => None,
    }
}
