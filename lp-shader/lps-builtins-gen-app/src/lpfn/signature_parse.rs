//! Parse `glsl::syntax` function prototypes into [`FunctionSignature`](crate::lpfn::types::FunctionSignature).
//!
//! Function prototype → signature parsing for the builtins codegen (string errors for the binary).

use crate::lpfn::types::{FunctionSignature, ParamQualifier, Parameter, Type};
