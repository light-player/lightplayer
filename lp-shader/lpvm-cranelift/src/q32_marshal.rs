//! Q32 marshalling between [`LpsValue`] and [`GlslQ32`] for LPVM call paths.

use alloc::string::String;
use alloc::vec::Vec;

use lps_shared::{LpsType, lps_value::LpsValue};

use crate::values::{CallError, GlslQ32};

/// Convert a typed [`LpsValue`] into Q32 representation for Cranelift / RV32 calls.
pub fn lps_value_to_glsl_q32(ty: &LpsType, v: &LpsValue) -> Result<GlslQ32, CallError> {
    Ok(match (ty, v) {
...
pub fn glsl_q32_to_lps_value(ty: &LpsType, v: GlslQ32) -> Result<LpsValue, CallError> {
