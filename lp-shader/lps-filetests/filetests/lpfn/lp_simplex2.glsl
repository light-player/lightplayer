...
// ============================================================================
// lpfn_snoise(): 2D Simplex noise function
// ============================================================================

float test_lpfn_snoise2_basic() {
...
float test_lpfn_snoise2_different_seeds() {
    ...
    float diff1 = abs(lpfn_snoise(vec2(0.5, 0.5), 0u) - lpfn_snoise(vec2(0.5, 0.5), 1u));
    float diff2 = abs(lpfn_snoise(vec2(1.5, 1.5), 0u) - lpfn_snoise(vec2(1.5, 1.5), 1u));
    float diff3 = abs(lpfn_snoise(vec2(2.5, 2.5), 0u) - lpfn_snoise(vec2(2.5, 2.5), 1u));
    float diff4 = abs(lpfn_snoise(vec2(3.5, 3.5), 0u) - lpfn_snoise(vec2(3.5, 3.5), 1u));
    float diff5 = abs(lpfn_snoise(vec2(4.5, 4.5), 0u) - lpfn_snoise(vec2(4.5, 4.5), 1u));
...
float test_lpfn_snoise2_different_positions() {
    ...
    float n1 = lpfn_snoise(vec2(0.0, 0.0), 0u);
    float n2 = lpfn_snoise(vec2(1.0, 1.0), 0u);
...
float test_lpfn_snoise2_range() {
    ...
    float n1 = lpfn_snoise(vec2(0.0, 0.0), 0u);
    float n2 = lpfn_snoise(vec2(1.0, 0.0), 0u);
    float n3 = lpfn_snoise(vec2(0.0, 1.0), 0u);
    float n4 = lpfn_snoise(vec2(10.0, 10.0), 0u);
