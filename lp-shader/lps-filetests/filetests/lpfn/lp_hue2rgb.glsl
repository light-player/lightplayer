...
// ============================================================================
// lpfn_hue2rgb(): Convert hue value to RGB color
// ============================================================================

float test_lpfn_hue2rgb_red() {
    // Hue 0.0 should produce red (1, 0, 0)
    vec3 rgb = lpfn_hue2rgb(0.0);
...
float test_lpfn_hue2rgb_range() {
    ...
    vec3 rgb1 = lpfn_hue2rgb(0.0);
    vec3 rgb2 = lpfn_hue2rgb(0.5);
    vec3 rgb3 = lpfn_hue2rgb(1.0);
