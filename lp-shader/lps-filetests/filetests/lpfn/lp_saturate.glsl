...
// ============================================================================
// lpfn_saturate(): Clamp values between 0 and 1
// ============================================================================

float test_lpfn_saturate_below_zero() {
    // Negative values should clamp to 0
    float result = lpfn_saturate(-0.5);
...
float test_lpfn_saturate_above_one() {
    ...
    float result = lpfn_saturate(1.5);
