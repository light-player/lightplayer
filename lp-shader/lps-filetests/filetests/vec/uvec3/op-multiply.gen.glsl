...
// To regenerate, run:
//   lps-filetests-gen-app vec/uvec3/op-multiply --write
//
// test run
...
uvec3 test_uvec3_multiply_fractions() {
    uvec3 a = uvec3(3u, 4u, 5u);
    uvec3 b = uvec3(5u, 2u, 1u);
    return a * b;
}

// run: test_uvec3_multiply_fractions() == uvec3(15u, 8u, 5u)
