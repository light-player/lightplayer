...
// To regenerate, run:
//   lps-filetests-gen-app vec/vec3/op-multiply --write
//
// test run
...
// run[q32]: test_vec3_multiply_large_numbers() ~= vec3(-14656.0, -31616.0, -29312.0)
// run[f32]: test_vec3_multiply_large_numbers() ~= vec3(3000000.0, 2000000.0, 6000000.0)
