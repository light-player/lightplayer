...
// To regenerate, run:
//   lps-filetests-gen-app vec/vec2/op-add --write
//
// test run
...
// run[q32]: test_vec2_add_large_numbers() ~= vec2(-0.000030517578, -2768.0)
// run[f32]: test_vec2_add_large_numbers() ~= vec2(300000.0, 80000.0)
