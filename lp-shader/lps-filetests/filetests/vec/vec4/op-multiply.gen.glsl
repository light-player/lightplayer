...
// run[q32]: test_vec4_multiply_large_numbers() ~= vec4(-14656.0, -31616.0, -29312.0, -31616.0)
// run[f32]: test_vec4_multiply_large_numbers() ~= vec4(3000000.0, 2000000.0, 6000000.0, 2000000.0)
