...
// To regenerate, run:
//   lps-filetests-gen-app vec/vec4/op-add --write
//
// test run
...
// run[q32]: test_vec4_add_large_numbers() ~= vec4(-0.000030517578, -2768.0, -25536.0, 15000.0)
// run[f32]: test_vec4_add_large_numbers() ~= vec4(300000.0, 80000.0, 40000.0, 15000.0)
