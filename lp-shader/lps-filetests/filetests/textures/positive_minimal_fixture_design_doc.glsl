...
// `texelFetch` lowers to ImageLoad and does not compile yet; this file still exercises
// parse, compile-time spec validation, fixture encode, allocation, and bind before `// run:`.
