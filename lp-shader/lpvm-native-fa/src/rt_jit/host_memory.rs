//! Global-allocator based [`LpvmMemory`] for native JIT (no pre-allocated arena).
//!
...
pub struct NativeHostMemory {
    live: Mutex<BTreeMap<u64, (usize, usize)>>,
}

impl NativeHostMemory {
    pub fn new() -> Self {
        Self {
...
impl Default for NativeHostMemory {
    fn default() -> Self {
        Self::new()
    }
}

impl LpvmMemory for NativeHostMemory {
