...
fn glsl_value_to_wasm_flat(
    ...
    Ok(match (ty, v) {
        ...
        (Texture2D, LpsValueF32::Texture2D(v)) => vec![
            Val::I32(v.descriptor.ptr as i32),
            Val::I32(v.descriptor.width as i32),
            Val::I32(v.descriptor.height as i32),
            Val::I32(v.descriptor.row_stride as i32),
        ],
