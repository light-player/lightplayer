...
pub fn generate(args: &Args) -> Result<()> {
    ...
    if !args.write {
        ...
        println!("  lp-glsl-filetests-gen-app {specifiers_str} --write");
    }
...
fn find_filetests_dir() -> Result<PathBuf> {
    ...
    if let Ok(manifest_dir) = std::env::var("CARGO_MANIFEST_DIR") {
        ...
        // From lp-shader/lp-glsl-filetests-gen-app, go to lp-shader/lp-glsl-filetests/filetests
    ...
    let candidates = vec![
        ...
        PathBuf::from("../lp-shader/lp-glsl-filetests/filetests"),
        PathBuf::from("lp-glsl-filetests/filetests"),
        PathBuf::from("../lp-glsl-filetests/filetests"),
    ...
    loop {
        let candidate = search_dir.join("../../lp-glsl-filetests/filetests");
        if !candidate.exists() {
