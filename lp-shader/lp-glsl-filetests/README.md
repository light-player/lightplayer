...
**Location:** `lp-shader/lp-glsl-filetests/` (this is the canonical test suite)
...
```bash
cd lp-shader/lp-glsl-filetests
...
- **Wrong workspace** — run from repo root or `lp-shader/lp-glsl-filetests` as above.
