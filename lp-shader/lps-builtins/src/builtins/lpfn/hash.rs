...
//! # GLSL Usage
//!
//! These functions are callable from GLSL shaders using the `lpfn_hash` name:
//!
//! ```glsl
//! uint h1 = lpfn_hash(42u, 123u);                    // 1D hash
//! uint h2 = lpfn_hash(uvec2(10u, 20u), 123u);      // 2D hash
//! uint h3 = lpfn_hash(uvec3(10u, 20u, 30u), 123u); // 3D hash
//! ```
//!
//! # Internal Implementation
//!
//! The user-facing `lpfn_hash` functions map to internal `__lp_lpfn_hash_*` functions
...
/// Hash value as u32
#[inline(always)]
pub fn lpfn_hash(x: u32, seed: u32) -> u32 {
    hash_impl(x, seed)
}
...
/// Hash value as u32
#[inline(always)]
pub fn lpfn_hash2(x: u32, y: u32, seed: u32) -> u32 {
...
/// Hash value as u32
#[inline(always)]
pub fn lpfn_hash3(x: u32, y: u32, z: u32, seed: u32) -> u32 {
...
/// # Returns
/// Hash value as u32
#[lpfn_impl_macro::lpfn_impl("uint lpfn_hash(uint x, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hash_1(x: u32, seed: u32) -> u32 {
    lpfn_hash(x, seed)
}
...
/// # Returns
/// Hash value as u32
#[lpfn_impl_macro::lpfn_impl("uint lpfn_hash(uvec2 xy, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hash_2(x: u32, y: u32, seed: u32) -> u32 {
    lpfn_hash2(x, y, seed)
}
...
/// # Returns
/// Hash value as u32
#[lpfn_impl_macro::lpfn_impl("uint lpfn_hash(uvec3 xyz, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hash_3(x: u32, y: u32, z: u32, seed: u32) -> u32 {
    lpfn_hash3(x, y, z, seed)
}
...
mod tests {
    ...
    fn test_hash_1_basic() {
        let result1 = __lp_lpfn_hash_1(0, 0);
        let result2 = __lp_lpfn_hash_1(1, 0);
        let result3 = __lp_lpfn_hash_1(0, 1);
    ...
    fn test_hash_1_deterministic() {
        let result1 = __lp_lpfn_hash_1(42, 123);
        let result2 = __lp_lpfn_hash_1(42, 123);
    ...
    fn test_hash_2_basic() {
        let result1 = __lp_lpfn_hash_2(0, 0, 0);
        let result2 = __lp_lpfn_hash_2(1, 0, 0);
        let result3 = __lp_lpfn_hash_2(0, 1, 0);
        let result4 = __lp_lpfn_hash_2(0, 0, 1);
    ...
    fn test_hash_2_deterministic() {
        let result1 = __lp_lpfn_hash_2(10, 20, 30);
        let result2 = __lp_lpfn_hash_2(10, 20, 30);
    ...
    fn test_hash_3_basic() {
        let result1 = __lp_lpfn_hash_3(0, 0, 0, 0);
        let result2 = __lp_lpfn_hash_3(1, 0, 0, 0);
        let result3 = __lp_lpfn_hash_3(0, 1, 0, 0);
        let result4 = __lp_lpfn_hash_3(0, 0, 1, 0);
        let result5 = __lp_lpfn_hash_3(0, 0, 0, 1);
    ...
    fn test_hash_3_deterministic() {
        let result1 = __lp_lpfn_hash_3(100, 200, 300, 400);
        let result2 = __lp_lpfn_hash_3(100, 200, 300, 400);
    ...
    fn test_hash_coordinate_combination() {
        ...
        let result1 = __lp_lpfn_hash_2(10, 20, 0);
        let result2 = __lp_lpfn_hash_2(20, 10, 0);
