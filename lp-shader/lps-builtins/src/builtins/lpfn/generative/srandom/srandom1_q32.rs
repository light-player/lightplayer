...
#[inline(always)]
pub fn lpfn_srandom1(x: Q32, seed: u32) -> Q32 {
    let random_val = lpfn_random1(x, seed);
    // -1.0 + 2.0 * random_val
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_srandom(float x, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_srandom1_q32(x: i32, seed: u32) -> i32 {
    lpfn_srandom1(Q32::from_fixed(x), seed).to_fixed()
}
...
mod tests {
    ...
    fn test_srandom1_range() {
        let result = __lp_lpfn_srandom1_q32(Q32::from_f32_wrapping(42.0).to_fixed(), 123);
