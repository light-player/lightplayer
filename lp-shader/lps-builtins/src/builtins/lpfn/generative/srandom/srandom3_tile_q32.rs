...
use crate::builtins::lpfn::generative::srandom::srandom3_vec_q32::lpfn_srandom3_vec;
use lps_q32::q32::Q32;
...
#[inline(always)]
pub fn lpfn_srandom3_tile(p: Vec3Q32, tile_length: Q32, seed: u32) -> Vec3Q32 {
    // mod(p, tile_length) component-wise
    let p_mod = Vec3Q32::new(
        Q32::from_fixed(crate::builtins::glsl::mod_q32::__lps_mod_q32(
            p.x.to_fixed(),
