...
#[inline(always)]
pub fn lpfn_gnoise3(p: Vec3Q32, seed: u32) -> Q32 {
    // i = floor(p), f = fract(p)
    let i = p.floor();
    let f = p.fract();
    ...
    let c100 = lpfn_random3(i + Vec3Q32::new(Q32::ONE, Q32::ZERO, Q32::ZERO), seed);
    let c010 = lpfn_random3(i + Vec3Q32::new(Q32::ZERO, Q32::ONE, Q32::ZERO), seed);
    let c110 = lpfn_random3(i + Vec3Q32::new(Q32::ONE, Q32::ONE, Q32::ZERO), seed);
    let c001 = lpfn_random3(i + Vec3Q32::new(Q32::ZERO, Q32::ZERO, Q32::ONE), seed);
    let c101 = lpfn_random3(i + Vec3Q32::new(Q32::ONE, Q32::ZERO, Q32::ONE), seed);
    let c011 = lpfn_random3(i + Vec3Q32::new(Q32::ZERO, Q32::ONE, Q32::ONE), seed);
    let c111 = lpfn_random3(i + Vec3Q32::one(), seed);
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_gnoise(vec3 p, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_gnoise3_q32(x: i32, y: i32, z: i32, seed: u32) -> i32 {
    lpfn_gnoise3(
...
mod tests {
    ...
    fn test_gnoise3_range() {
        let result = __lp_lpfn_gnoise3_q32(
