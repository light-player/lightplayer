...
pub fn lpfn_gnoise3_tile(p: Vec3Q32, tile_length: Q32, seed: u32) -> Q32 {
    ...
    let g000 = lpfn_srandom3_tile(i + Vec3Q32::zero(), scaled_tile, seed);
    let g100 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ONE, Q32::ZERO, Q32::ZERO),
        scaled_tile,
        seed,
    );
    let g010 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ZERO, Q32::ONE, Q32::ZERO),
        scaled_tile,
        seed,
    );
    let g110 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ONE, Q32::ONE, Q32::ZERO),
        scaled_tile,
        seed,
    );
    let g001 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ZERO, Q32::ZERO, Q32::ONE),
        scaled_tile,
        seed,
    );
    let g101 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ONE, Q32::ZERO, Q32::ONE),
        scaled_tile,
        seed,
    );
    let g011 = lpfn_srandom3_tile(
        i + Vec3Q32::new(Q32::ZERO, Q32::ONE, Q32::ONE),
        scaled_tile,
        seed,
    );
    let g111 = lpfn_srandom3_tile(i + Vec3Q32::one(), scaled_tile, seed);
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_gnoise(vec3 p, float tileLength, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_gnoise3_tile_q32(
    x: i32,
    y: i32,
    z: i32,
    tile_length: i32,
...
mod tests {
    ...
    fn test_gnoise3_tile_range() {
        let result = __lp_lpfn_gnoise3_tile_q32(
