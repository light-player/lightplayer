...
use crate::builtins::lpfn::generative::gnoise::gnoise3_tile_q32::lpfn_gnoise3_tile;
use lps_q32::q32::Q32;
...
#[inline(always)]
pub fn lpfn_fbm3_tile(p: Vec3Q32, tile_length: Q32, octaves: i32, seed: u32) -> Q32 {
    ...
    for _ in 0..octaves {
        ...
        let noise_value = lpfn_gnoise3_tile(pos, scaled_tile, seed);
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_fbm3_tile_q32(
    x: i32,
    y: i32,
    z: i32,
    tile_length: i32,
...
mod tests {
    ...
    fn test_fbm3_tile_range() {
        let result = __lp_lpfn_fbm3_tile_q32(
