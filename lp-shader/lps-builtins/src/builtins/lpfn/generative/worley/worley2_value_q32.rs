...
//! # GLSL Usage
//!
//! This function is callable from GLSL shaders using the `lpfn_worley_value` name:
//!
//! ```glsl
//! float noise = lpfn_worley_value(vec2(5.0, 3.0), 123u);
//! ```
//!
//! # Parameters
//!
...
pub fn lpfn_worley2_value(p: Vec2Q32, seed: u32) -> Q32 {
    let x = p.x;
    let y = p.y;
    ...
    let hash_value = lpfn_hash2(seed_cell_x as u32, seed_cell_y as u32, seed);
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_worley_value(vec2 p, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_worley2_value_q32(x: i32, y: i32, seed: u32) -> i32 {
    let p = Vec2Q32::new(Q32::from_fixed(x), Q32::from_fixed(y));
    lpfn_worley2_value(p, seed).to_fixed()
}
...
mod tests {
    ...
    fn test_worley2_value_basic() {
        let result1 = __lp_lpfn_worley2_value_q32(float_to_fixed(1.5), float_to_fixed(2.3), 0);
        let result2 = __lp_lpfn_worley2_value_q32(float_to_fixed(3.7), float_to_fixed(2.3), 0);
        let result3 = __lp_lpfn_worley2_value_q32(float_to_fixed(1.5), float_to_fixed(2.3), 1);
    ...
    fn test_worley2_value_range() {
        ...
        for i in 0..50 {
            ...
            let result = __lp_lpfn_worley2_value_q32(x, y, 0);
    ...
    fn test_worley2_value_deterministic() {
        let result1 = __lp_lpfn_worley2_value_q32(float_to_fixed(42.5), float_to_fixed(37.3), 123);
        let result2 = __lp_lpfn_worley2_value_q32(float_to_fixed(42.5), float_to_fixed(37.3), 123);
    ...
    fn test_worley2_value_different_from_distance() {
        ...
        let distance_result = __lp_lpfn_worley2_q32(x, y, seed);
        let value_result = __lp_lpfn_worley2_value_q32(x, y, seed);
