//! 3D Worley noise function (value variant).
//!
...
//!
//! ```glsl
//! float noise = lpfn_worley_value(vec3(5.0, 3.0, 1.0), 123u);
//! ```
//!
//! # Parameters
//!
...
pub fn lpfn_worley3_value(p: Vec3Q32, seed: u32) -> Q32 {
    let x = p.x;
    let y = p.y;
    let z = p.z;
    ...
    let mut seed_cell_z = near_z_int;
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_worley_value(vec3 p, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_worley3_value_q32(x: i32, y: i32, z: i32, seed: u32) -> i32 {
    let p = Vec3Q32::new(Q32::from_fixed(x), Q32::from_fixed(y), Q32::from_fixed(z));
    lpfn_worley3_value(p, seed).to_fixed()
}
...
mod tests {
    ...
    #[test]
    fn test_worley3_value_basic() {
        let result1 = __lp_lpfn_worley3_value_q32(
            float_to_fixed(1.5),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            0,
        );
        let result2 = __lp_lpfn_worley3_value_q32(
            float_to_fixed(3.7),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            0,
        );
        let result3 = __lp_lpfn_worley3_value_q32(
            float_to_fixed(1.5),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            1,
    ...
    fn test_worley3_value_range() {
        ...
        for i in 0..50 {
            ...
            let result = __lp_lpfn_worley3_value_q32(x, y, z, 0);
    ...
    #[test]
    fn test_worley3_value_deterministic() {
        let result1 = __lp_lpfn_worley3_value_q32(
            float_to_fixed(42.5),
            float_to_fixed(37.3),
            float_to_fixed(15.7),
    ...
    fn test_worley3_value_different_from_distance() {
        ...
        let z = float_to_fixed(1.7);
        let seed = 42;

        let distance_result = __lp_lpfn_worley3_q32(x, y, z, seed);
        let value_result = __lp_lpfn_worley3_value_q32(x, y, z, seed);
