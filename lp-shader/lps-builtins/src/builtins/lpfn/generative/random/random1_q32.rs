...
#[inline(always)]
pub fn lpfn_random1(x: Q32, seed: u32) -> Q32 {
    // Combine x and seed
    let combined = x.to_fixed().wrapping_add(seed as i32);

    // sin(combined) * 43758.5453
    let sin_val = __lps_sin_q32(combined);
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_random(float x, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_random1_q32(x: i32, seed: u32) -> i32 {
    lpfn_random1(Q32::from_fixed(x), seed).to_fixed()
}
...
mod tests {
    ...
    fn test_random1_basic() {
        let result1 = __lp_lpfn_random1_q32(Q32::from_f32_wrapping(0.0).to_fixed(), 0);
        let result2 = __lp_lpfn_random1_q32(Q32::from_f32_wrapping(1.0).to_fixed(), 0);
        let result3 = __lp_lpfn_random1_q32(Q32::from_f32_wrapping(0.0).to_fixed(), 1);
    ...
    fn test_random1_deterministic() {
        let result1 = __lp_lpfn_random1_q32(Q32::from_f32_wrapping(42.0).to_fixed(), 123);
        let result2 = __lp_lpfn_random1_q32(Q32::from_f32_wrapping(42.0).to_fixed(), 123);
