...
#[inline(always)]
pub fn lpfn_random2(p: Vec2Q32, seed: u32) -> Q32 {
...
#[lpfn_impl_macro::lpfn_impl(q32, "float lpfn_random(vec2 p, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_random2_q32(x: i32, y: i32, seed: u32) -> i32 {
    lpfn_random2(Vec2Q32::new(Q32::from_fixed(x), Q32::from_fixed(y)), seed).to_fixed()
}
...
mod tests {
    ...
    fn test_random2_basic() {
        let result1 = __lp_lpfn_random2_q32(
            Q32::from_f32_wrapping(0.0).to_fixed(),
            Q32::from_f32_wrapping(0.0).to_fixed(),
            0,
        );
        let result2 = __lp_lpfn_random2_q32(
            Q32::from_f32_wrapping(1.0).to_fixed(),
            Q32::from_f32_wrapping(0.0).to_fixed(),
            0,
        );
        let result3 = __lp_lpfn_random2_q32(
            Q32::from_f32_wrapping(0.0).to_fixed(),
            Q32::from_f32_wrapping(0.0).to_fixed(),
            1,
        );
