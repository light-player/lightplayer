...
use crate::builtins::lpfn::math::saturate_q32::lpfn_saturate_vec3_q32;
use lps_q32::q32::Q32;
...
#[inline(always)]
pub fn lpfn_hue2rgb_q32(hue: Q32) -> Vec3Q32 {
...
#[lpfn_impl_macro::lpfn_impl(q32, "vec3 lpfn_hue2rgb(float hue)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hue2rgb_q32(result_ptr: *mut i32, hue: i32) {
    // Convert raw pointer to safe array reference at boundary
    let result = unsafe { &mut *result_ptr.cast::<[i32; 3]>() };
    let rgb = lpfn_hue2rgb_q32(Q32::from_fixed(hue));
...
mod tests {
    ...
    fn test_hue2rgb_red() {
        ...
        let result = lpfn_hue2rgb_q32(Q32::ZERO);
    ...
    fn test_hue2rgb_green() {
        ...
        let result = lpfn_hue2rgb_q32(hue);
        let r = fixed_to_float(result.x.to_fixed());
        let g = fixed_to_float(result.y.to_fixed());
        let b = fixed_to_float(result.z.to_fixed());
