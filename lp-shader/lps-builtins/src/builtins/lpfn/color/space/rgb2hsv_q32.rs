...
#[inline(always)]
pub fn lpfn_rgb2hsv_q32(rgb: Vec3Q32) -> Vec3Q32 {
...
#[inline(always)]
pub fn lpfn_rgb2hsv_vec4_q32(rgb: Vec4Q32) -> Vec4Q32 {
    let rgb_vec3 = Vec3Q32::new(rgb.x, rgb.y, rgb.z);
    let hsv_vec3 = lpfn_rgb2hsv_q32(rgb_vec3);
...
#[lpfn_impl_macro::lpfn_impl(q32, "vec3 lpfn_rgb2hsv(vec3 rgb)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_rgb2hsv_q32(result_ptr: *mut i32, x: i32, y: i32, z: i32) {
...
#[lpfn_impl_macro::lpfn_impl(q32, "vec4 lpfn_rgb2hsv(vec4 rgb)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_rgb2hsv_vec4_q32(result_ptr: *mut i32, x: i32, y: i32, z: i32, w: i32) {
    // Convert raw pointer to safe array reference at boundary
    ...
    let hsv = lpfn_rgb2hsv_vec4_q32(rgb);
    result[0] = hsv.x.to_fixed();
    result[1] = hsv.y.to_fixed();
    result[2] = hsv.z.to_fixed();
...
mod tests {
    ...
    extern crate std;
    use super::*;
    use crate::builtins::lpfn::color::space::hsv2rgb_q32::lpfn_hsv2rgb_q32;
    ...
    fn test_rgb2hsv_round_trip() {
        ...
        for hsv_original in test_hsvs {
            let rgb = lpfn_hsv2rgb_q32(hsv_original);
            let hsv_roundtrip = lpfn_rgb2hsv_q32(rgb);
