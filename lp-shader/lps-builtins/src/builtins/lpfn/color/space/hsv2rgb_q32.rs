...
use crate::builtins::lpfn::color::space::hue2rgb_q32::lpfn_hue2rgb_q32;
use lps_q32::q32::Q32;
...
#[inline(always)]
pub fn lpfn_hsv2rgb_q32(hsv: Vec3Q32) -> Vec3Q32 {
    // Algorithm from lygia: ((hue2rgb(hsv.x) - 1.0) * hsv.y + 1.0) * hsv.z
    let hue_rgb = lpfn_hue2rgb_q32(hsv.x);
...
#[inline(always)]
pub fn lpfn_hsv2rgb_vec4_q32(hsv: Vec4Q32) -> Vec4Q32 {
    let hsv_vec3 = Vec3Q32::new(hsv.x, hsv.y, hsv.z);
    let rgb_vec3 = lpfn_hsv2rgb_q32(hsv_vec3);
...
#[lpfn_impl_macro::lpfn_impl(q32, "vec3 lpfn_hsv2rgb(vec3 hsv)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hsv2rgb_q32(result_ptr: *mut i32, x: i32, y: i32, z: i32) {
...
#[lpfn_impl_macro::lpfn_impl(q32, "vec4 lpfn_hsv2rgb(vec4 hsv)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfn_hsv2rgb_vec4_q32(result_ptr: *mut i32, x: i32, y: i32, z: i32, w: i32) {
    // Convert raw pointer to safe array reference at boundary
    ...
    let rgb = lpfn_hsv2rgb_vec4_q32(hsv);
    result[0] = rgb.x.to_fixed();
    result[1] = rgb.y.to_fixed();
    result[2] = rgb.z.to_fixed();
...
mod tests {
    ...
    extern crate std;
    use super::*;
    use crate::builtins::lpfn::color::space::rgb2hsv_q32::lpfn_rgb2hsv_q32;
    ...
    fn test_hsv2rgb_round_trip() {
        ...
        for rgb_original in test_colors {
            let hsv = lpfn_rgb2hsv_q32(rgb_original);
            let rgb_roundtrip = lpfn_hsv2rgb_q32(hsv);
