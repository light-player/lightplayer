...
#[unsafe(no_mangle)]
pub extern "C" fn __lps_tan_q32(x: i32) -> i32 {
    let sin_val = __lps_sin_q32(x);
    let cos_val = __lps_cos_q32(x);
...
mod tests {
    ...
    fn test_tan_basic() {
        ...
        test_q32_function_relative(|x| __lps_tan_q32(x), &tests, 0.03, 0.01);
    }
    ...
    fn test_tan_range_reduction() {
        ...
        test_q32_function_relative(|x| __lps_tan_q32(x), &tests, 0.05, 0.01);
    }
}
