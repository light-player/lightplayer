...
use crate::builtins::lpfx::color::space::hsv2rgb_q32::__lp_lpfx_hsv2rgb_q32;
use crate::builtins::lpfx::color::space::hsv2rgb_q32::__lp_lpfx_hsv2rgb_vec4_q32;
use lps_q32::q32::Q32;
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_hsv2rgb_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32) {
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_hsv2rgb_vec4_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32, w: f32) {
    // Convert raw pointer to safe array reference at boundary
