...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_worley3_q32(x: i32, y: i32, z: i32, seed: u32) -> i32 {
...
mod tests {
    ...
    fn test_worley3_basic() {
        let result1 = __lp_lpfx_worley3_q32(
            float_to_fixed(1.5),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            0,
        );
        let result2 = __lp_lpfx_worley3_q32(
            float_to_fixed(3.7),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            0,
        );
        let result3 = __lp_lpfx_worley3_q32(
            float_to_fixed(1.5),
            float_to_fixed(2.3),
            float_to_fixed(0.7),
            1,
    ...
    fn test_worley3_range() {
        ...
        for i in 0..50 {
            ...
            let result = __lp_lpfx_worley3_q32(x, y, z, 0);
