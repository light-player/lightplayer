//! 2D Worley noise function (float implementation - stub).
//!
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_worley2_f32(x: f32, y: f32, seed: u32) -> f32 {
    // Stub: convert to q32, call q32 version, convert back
    let x_q32 = Q32::from_f32(x);
    let y_q32 = Q32::from_f32(y);
    let result_fixed = __lp_lpfx_worley2_q32(x_q32.to_fixed(), y_q32.to_fixed(), seed);
