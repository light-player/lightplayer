...
//!
//! The user-facing `lpfx_snoise` function maps to internal `__lp_lpfx_snoise2` which
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_snoise2_q32(x: i32, y: i32, seed: u32) -> i32 {
...
mod tests {
    ...
    fn test_simplex2_basic() {
        let result1 = __lp_lpfx_snoise2_q32(float_to_fixed(1.5), float_to_fixed(2.3), 0);
        let result2 = __lp_lpfx_snoise2_q32(float_to_fixed(3.7), float_to_fixed(2.3), 0);
        let result3 = __lp_lpfx_snoise2_q32(float_to_fixed(1.5), float_to_fixed(2.3), 1);
    ...
    fn test_simplex2_range() {
        ...
        for i in 0..50 {
            ...
            let result = __lp_lpfx_snoise2_q32(x, y, 0);
    ...
    fn test_simplex2_deterministic() {
        let result1 = __lp_lpfx_snoise2_q32(float_to_fixed(42.5), float_to_fixed(37.3), 123);
        let result2 = __lp_lpfx_snoise2_q32(float_to_fixed(42.5), float_to_fixed(37.3), 123);
