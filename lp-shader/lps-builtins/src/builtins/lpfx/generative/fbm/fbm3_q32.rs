...
/// Noise value as Q32
#[inline(always)]
pub fn lpfx_fbm3(p: Vec3Q32, octaves: i32, seed: u32) -> Q32 {
    // Initial values
...
#[lpfx_impl_macro::lpfx_impl(q32, "float lpfx_fbm(vec3 p, int octaves, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_fbm3_q32(x: i32, y: i32, z: i32, octaves: i32, seed: u32) -> i32 {
    lpfx_fbm3(
