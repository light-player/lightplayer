...
build-glsl:
    cargo build --package lp-glsl-builtins --package lp-glsl-filetests-gen-app --package lpir-cranelift --package lp-glsl-filetests --package lp-riscv-emu-shared --package lp-glsl-builtins-gen-app --package lp-glsl-filetests-app --package lp-glsl-naga --package lp-glsl-exec --package lp-glsl-abi --package lp-glsl-diagnostics --package lps-types --package lpir --package lp-glsl-builtin-ids --package lp-glsl-wasm
