...
**File**: `lp-glsl/crates/lp-builtins/src/builtins/q32/lpfx_simplex2.rs` (in test module)
    ...
    fn test_simplex2_generate_image() {
        ...
        for y in 0..HEIGHT {
            for x in 0..WIDTH {
                ...
                let noise = __lp_q32_lpfx_simplex2(float_to_fixed(fx), float_to_fixed(fy), 0);
...
mod comparison_tests {
    ...
    fn test_simplex2_compare_with_noise_rs() {
        ...
        for (x, y) in test_points {
            let our_value = __lp_q32_lpfx_simplex2(float_to_fixed(x), float_to_fixed(y), 0);
...
fn test_simplex2_no_discontinuities() {
    ...
    for i in 0..1000 {
        ...
        let result = __lp_q32_lpfx_simplex2(float_to_fixed(x), float_to_fixed(y), 0);
