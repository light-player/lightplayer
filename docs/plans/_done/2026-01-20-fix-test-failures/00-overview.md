...
3. Fixed32 transform tests returning 0 (13 tests) - Likely same root cause as #2
4. Other tests (4 tests) - Individual investigation needed

## Phases

1. Fix JIT tests - Update to use Fixed32 format
2. Investigate emulator execution bug - Debug why functions return 0
3. Fix emulator execution bug - Implement the fix
4. Verify fixed32 tests - Should work after phase 3
