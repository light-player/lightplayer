...
- Includes:
  ...
  - Sign checking
  - Two division paths (shifted divisor vs full divisor) - handles edge case for small divisors < 2^16
  - Saturation logic
...
- **Note**: This may be intentional to handle edge cases, but still contributes significantly to bloat
...
### Available Builtins
- **Arithmetic**: `mul`, `div`
- **Math functions**: `sin`, `cos`, `tan`, `asin`, `acos`, `atan`, `sinh`, `cosh`, `tanh`, `asinh`, `acosh`, `atanh`
