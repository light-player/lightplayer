...
## i. Extract lp-glsl-frontend

Mechanical refactor. Move shared frontend code out of lp-glsl-compiler
into lp-glsl-frontend. Rename lp-glsl-compiler to lp-glsl-cranelift.
Update all internal imports. All existing tests pass unchanged.
No new functionality.

## ii. WASM codegen foundation + filetest infrastructure

Create lp-glsl-wasm with scaffolding: module builder, codegen context,
...
Compile lp-glsl-builtins to .wasm. Build playground wasm-pack project.
