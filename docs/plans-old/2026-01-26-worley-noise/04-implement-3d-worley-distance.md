...
1. **`lps-builtins/src/builtins/lpfn/worley/worley3_q32.rs`**
...
- Feature point generation using hash function (call `__lpfn_hash_3`)
...
- Function uses `__lpfn_hash_3` from hash module
