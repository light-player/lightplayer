...
Update function definition codegen to handle out/inout parameters that arrive as pointers.
Parameters should be stored as pointers and accessed via load/store operations.

## Implementation

### Files to Modify

1. **`lp-shader/lps-compiler/src/frontend/glsl_compiler.rs`**
...
2. **`lp-shader/lps-compiler/src/frontend/codegen/lvalue/read.rs`**
    - Handle reading from out/inout parameter variables (load from pointer)

3. **`lp-shader/lps-compiler/src/frontend/codegen/lvalue/write.rs`**
