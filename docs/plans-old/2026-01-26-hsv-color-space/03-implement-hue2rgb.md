...
### File: `lpfn/color/space/hue2rgb_q32.rs`

Implement following the two-layer pattern:

**Public Rust function:**
- `lpfn_hue2rgb_q32(hue: Q32) -> Vec3Q32` - Convert hue value to RGB
  ...
  - Result should be saturated using `lpfn_saturate_vec3_q32` (calls the public Rust function)

**Extern C wrapper:**
- `__lpfn_hue2rgb_q32(hue: i32) -> (i32, i32, i32)` - Wraps `lpfn_hue2rgb_q32`
  - `#[lpfn_impl_macro::lpfn_impl]` annotation with GLSL signature
  - `#[unsafe(no_mangle)]` and `pub extern "C"` attributes
  - Converts i32 to Q32, calls `lpfn_hue2rgb_q32`, converts Vec3Q32 result back to three i32s

### Update Module

Update `lpfn/color/space/mod.rs` to export `hue2rgb_q32`.
