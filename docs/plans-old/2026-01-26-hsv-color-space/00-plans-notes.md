...
`lp-shader/lps-builtins/src/builtins/lpfx`. Lygia has:
...
- `lp-shader/lps-builtins/src/builtins/lpfx/color/space/` for HSV functions and `hue2rgb`
- `lp-shader/lps-builtins/src/builtins/lpfx/math/` for `saturate`
