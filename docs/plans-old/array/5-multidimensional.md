...
Test file: `lightplayer/crates/lps-filetests/filetests/array/phases/5-multidimensional.glsl`
...
- `lightplayer/crates/lps-compiler/src/frontend/codegen/context.rs` (verify multi-dim size calculation)
