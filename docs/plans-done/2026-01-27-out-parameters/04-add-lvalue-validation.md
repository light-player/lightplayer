...
Add compile-time validation that out/inout arguments are lvalues (variables, array elements, etc.), not expressions.
...
- Valid lvalue arguments (variables, array elements, vector components, struct fields) pass validation
...
- Valid lvalues: variables, array elements, vector components (swizzles), struct fields, matrix elements/columns
