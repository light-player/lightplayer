...
1. `lp-shader/lp-glsl-builtins/src/builtins/q32/lpfx_snoise2.rs`
2. `lp-shader/lp-glsl-builtins/src/builtins/q32/lpfx_snoise3.rs`
3. `lp-shader/lp-glsl-builtins/Cargo.toml` (add features)
4. `lp-shader/lp-glsl-builtins/src/builtins/shared/lpfx_hash.rs` (conditional compilation)
5. New: `lp-shader/lp-glsl-builtins/src/builtins/shared/test_hash.rs`
