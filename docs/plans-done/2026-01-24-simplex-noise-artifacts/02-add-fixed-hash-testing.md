...
**File**: `lp-shader/lp-glsl-builtins/src/builtins/shared/test_hash.rs` (new file)
...
**File**: `lp-shader/lp-glsl-builtins/src/builtins/shared/lpfx_hash.rs`
...
**File**: `lp-shader/lp-glsl-builtins/src/builtins/q32/lpfx_snoise3.rs`
