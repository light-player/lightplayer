...
1. Add tests to `lp-glsl/crates/lp-glsl-compiler/src/backend/builtins/registry.rs`:
...
2. Add tests to `lp-glsl/crates/lp-glsl-compiler/src/frontend/semantic/lpfx/lpfx_fn_registry.rs`:
