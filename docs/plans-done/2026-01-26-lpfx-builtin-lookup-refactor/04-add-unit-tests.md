...
1. Add tests to `lp-shader/lp-glsl-compiler/src/backend/builtins/registry.rs`:
...
2. Add tests to `lp-shader/lp-glsl-compiler/src/frontend/semantic/lpfx/lpfx_fn_registry.rs`:
