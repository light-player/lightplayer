...
Discover all LPFX functions in the `lp-builtins/src/builtins/lpfx` directory that have `#[lpfx_impl(...)]` attributes.

## Implementation

1. Create `lp-builtin-gen/src/discovery.rs` (or extend existing discovery)
