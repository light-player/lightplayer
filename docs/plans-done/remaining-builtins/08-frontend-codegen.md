...
- File: `lightplayer/crates/lps-compiler/src/frontend/codegen/builtins/common.rs`
...
- File: `lightplayer/crates/lps-compiler/src/frontend/codegen/builtins/` (appropriate module)

## Files to Modify
- `lightplayer/crates/lps-compiler/src/frontend/codegen/builtins/common.rs` - add floatBitsToInt, intBitsToFloat
- `lightplayer/crates/lps-compiler/src/frontend/codegen/builtins/mod.rs` - wire up new functions
