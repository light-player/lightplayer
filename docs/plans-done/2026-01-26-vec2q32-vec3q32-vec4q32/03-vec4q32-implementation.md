...
Create `lp-glsl/crates/lp-builtins/src/util/vec4_q32.rs` with:
...
- GLSL-style swizzle methods:
  ...
  - 2-component swizzles returning `Vec2Q32`: `.xy()`, `.xz()`, `.xw()`, `.yz()`, `.yw()`, `.zw()`, and RGBA variants
  - 3-component swizzles returning `Vec3Q32`: `.xyz()`, `.xyw()`, `.xzw()`, `.yzw()`, and RGBA variants
...
- All swizzle methods work correctly (including 2-component and 3-component swizzles returning `Vec2Q32` and `Vec3Q32`)
