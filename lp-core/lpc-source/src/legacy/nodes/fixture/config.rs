use crate::legacy::nodes::fixture::mapping::MappingConfig;
use crate::legacy::nodes::{NodeConfig, NodeKind};
...
mod tests {
    use super::*;
    use crate::legacy::nodes::fixture::mapping::{MappingConfig, PathSpec, RingOrder};
    use alloc::vec;
