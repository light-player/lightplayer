...
Does _not_ include core model/wire definitions, which live in `lpc-model` and
`lpc-wire`. Cross-crate naming conventions for those layers are documented in
each crate’s README (see M4.3b naming boundaries on `lp-core/README.md`).
