...
use super::{
    HardwareAddress, HardwareCapability, HardwareManifest, HardwareResource, HardwareTarget,
};
...
impl From<super::HardwareError> for HardwareManifestFileError {
    fn from(error: super::HardwareError) -> Self {
        Self::Hardware(error)
    }
}
