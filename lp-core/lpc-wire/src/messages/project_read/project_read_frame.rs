...
/// Budget derivation chain (single source of truth).
///
/// Every project-read sizing constant below traces back to
/// [`PROJECT_READ_FRAME_MAX_BYTES`]. The frame batcher
/// ([`ProjectReadFrameSink`](../../../../lpc_shared/transport/server/struct.ProjectReadFrameSink.html))
...
/// are intentionally excluded (they are accounted for separately in the serial
/// buffer size).
...
/// `ProjectReadFrame` envelope (`{"id":..,"msg":{"projectReadFrame":{"sequence":
