...
/// Parent-owned placement for a child project node occurrence.
///
/// Placement describes the authored container position that produced a child
/// occurrence. It is model-owned so registry and engine code do not have to
/// parse project or playlist internals to understand how a child was placed.
