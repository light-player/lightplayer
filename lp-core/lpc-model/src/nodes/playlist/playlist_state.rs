...
impl PlaylistState {
    pub fn new(output: VisualProduct, entry_time: f32, active_entry: u32) -> Self {
        Self {
...
mod tests {
    ...
    fn playlist_state_fields_are_produced() {
        ...
        for name in ["output", "entry_time", "active_entry"] {
            let field = fields
                .iter()
    ...
    fn playlist_state_new_sets_public_outputs() {
        let state = PlaylistState::new(VisualProduct::new(NodeId::new(4), 0), 1.5, 2);
