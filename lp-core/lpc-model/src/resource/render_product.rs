...
//!
//! A [`RenderProduct`] is the value that moves through node slots when a node
...
mod tests {
    ...
    #[test]
    fn render_product_keeps_owner_and_output() {
        let product = RenderProduct::new(NodeId::new(7), 2);
