...
Sister documents: [`color.md`](../../design/color.md) (color-specific
contract), [`q32.md`](../../design/q32.md) (int-only fixed-point fallback),
...
5. **F32 is canonical numeric type.** Q16.16 (`Q32`) is the int-only
   firmware fallback. See [`color.md`](../../design/color.md) for the full
   precision contract.
...
Color-family recipes are locked in [`color.md`](../../design/color.md). The
others:
...
See [`color.md`](../../design/color.md) for color-specific non-negotiables
