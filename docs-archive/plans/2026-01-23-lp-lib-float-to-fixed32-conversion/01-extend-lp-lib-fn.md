...
- Return `Some("__lp_q32_lpfn_snoise1")` for `Simplex1`
- Return `Some("__lp_q32_lpfn_snoise2")` for `Simplex2`
- Return `Some("__lp_q32_lpfn_snoise3")` for `Simplex3`
...
- `LpLibFn::Simplex1.q32_name()` returns `Some("__lp_q32_lpfn_snoise1")`
