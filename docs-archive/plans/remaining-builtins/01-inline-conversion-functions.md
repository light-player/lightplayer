...
- Add conversion function in `lightplayer/crates/lps-compiler/src/backend/transform/q32/converters/math.rs`
...
- Add conversion functions in `lightplayer/crates/lps-compiler/src/backend/transform/q32/converters/math.rs`

## Files to Modify
- `lightplayer/crates/lps-compiler/src/backend/transform/q32/converters/math.rs` - add conversion functions
- `lightplayer/crates/lps-compiler/src/backend/transform/q32/instructions.rs` - wire up conversions
