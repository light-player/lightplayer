        ...
        LValue::PointerBased {
            ...
            match access_pattern {
                PointerAccessPattern::Direct { component_count } => {
                    // Load all components; for arrays, use element type
                    ...
                    let base_cranelift_ty = if scalar_ty.is_vector() {
                        ...
                        if base == GlslType::Float {
                            ...
                            crate::frontend::codegen::glsl_types::glsl_type_to_cranelift(&base)
                                .map_err(|e| {
                                    GlslError::new(
                                        ErrorCode::E0400,
                        ...
                        crate::frontend::codegen::glsl_types::glsl_type_to_cranelift(&scalar_ty)
                            .map_err(|e| {
                                GlslError::new(
                                    ErrorCode::E0400,
                                    format!("Failed to convert type: {}", e.message),
                ...
                PointerAccessPattern::ArrayElement {
                    ...
                    let base_cranelift_ty = if element_ty.is_vector() {
                        ...
                        if base_ty == GlslType::Float {
                            ...
                            crate::frontend::codegen::glsl_types::glsl_type_to_cranelift(&base_ty)
                                .map_err(|e| {
                                GlslError::new(
                                    ErrorCode::E0400,
                        ...
                        crate::frontend::codegen::glsl_types::glsl_type_to_cranelift(&element_ty)
                            .map_err(|e| {
                                GlslError::new(
                                    ErrorCode::E0400,
