//! Cranelift signature building for LPFX functions.
//!
...
use alloc::vec::Vec;
use cranelift_codegen::ir::{AbiParam, Signature, Type as IrType, Value, types};
use cranelift_codegen::isa::CallConv;
use lp_glsl_frontend::semantic::lpfx::lpfx_fn::LpfxFn;
...
pub fn expand_vector_args(param_types: &[Type], values: &[Value]) -> Vec<Value> {
