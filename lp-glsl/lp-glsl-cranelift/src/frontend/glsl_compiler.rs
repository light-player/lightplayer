...
use lp_glsl_frontend::pipeline::CompilationPipeline;
...
impl GlslCompiler {
    ...
    pub fn compile_to_gl_module_jit(
        ...
        use lp_glsl_frontend::src_loc_manager::SourceLocManager;
        ...
        let main_file_id = source_map.add_file(
            lp_glsl_frontend::src_loc::GlFileSource::Synthetic(String::from("main.glsl")),
            String::from(source),
        );
        ...
        for user_func in &typed_ast.user_functions {
            ...
            let glsl_sig = lp_glsl_frontend::semantic::functions::FunctionSignature {
    ...
    pub(crate) fn compile_single_function_to_clif<M: Module>(
        &mut self,
        func: &lp_glsl_frontend::semantic::TypedFunction,
        _func_id: FuncId,
        func_ids: &HashMap<String, FuncId>,
        func_registry: &lp_glsl_frontend::semantic::functions::FunctionRegistry,
        global_constants: &hashbrown::HashMap<
            String,
            lp_glsl_frontend::semantic::const_eval::ConstValue,
        >,
        gl_module: &mut crate::backend::module::gl_module::GlModule<M>,
        isa: &dyn cranelift_codegen::isa::TargetIsa,
        source_loc_manager: &mut lp_glsl_frontend::src_loc_manager::SourceLocManager,
        source_map: &mut lp_glsl_frontend::src_loc::GlSourceMap,
    ...
    fn compile_main_function_to_clif<M: Module>(
        &mut self,
        main_func: &lp_glsl_frontend::semantic::TypedFunction,
        func_ids: &HashMap<String, FuncId>,
        func_registry: &lp_glsl_frontend::semantic::functions::FunctionRegistry,
        global_constants: &hashbrown::HashMap<
            String,
