...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_rgb2hsv_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32) {
...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_lpfx_rgb2hsv_vec4_f32(result_ptr: *mut f32, x: f32, y: f32, z: f32, w: f32) {
    // Convert raw pointer to safe array reference at boundary
