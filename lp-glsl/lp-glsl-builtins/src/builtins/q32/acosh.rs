...
/// Domain: x >= 1
#[unsafe(no_mangle)]
pub extern "C" fn __lp_glsl_acosh_q32(x: i32) -> i32 {
    ...
    // Compute sqrt(x² - 1)
    let sqrt_val = __lp_lpir_fsqrt_q32(x_sq_minus_one);
...
mod tests {
    ...
    fn test_acosh_basic() {
        ...
        test_q32_function_relative(|x| __lp_glsl_acosh_q32(x), &tests, 0.05, 0.01);
    }
}
