...
mod tests {
    ...
    fn test_basic_addition() {
        ...
        for (a, b, expected) in tests {
            ...
            let result_fixed = __lp_fixed32_add(a_fixed, b_fixed);
    ...
    fn test_zero_handling() {
        ...
        assert_eq!(__lp_fixed32_add(one, zero), one, "1 + 0 should be 1");
        assert_eq!(__lp_fixed32_add(zero, one), one, "0 + 1 should be 1");
        assert_eq!(__lp_fixed32_add(zero, zero), 0, "0 + 0 should be 0");
    }
    ...
    fn test_overflow_saturation() {
        ...
        let result = __lp_fixed32_add(large_a, large_b);
    ...
    fn test_underflow_saturation() {
        ...
        let result = __lp_fixed32_add(large_neg_a, large_neg_b);
