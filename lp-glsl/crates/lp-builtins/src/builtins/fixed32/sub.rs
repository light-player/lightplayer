...
#[unsafe(no_mangle)]
pub extern "C" fn __lp_fixed32_sub(a: i32, b: i32) -> i32 {
...
mod tests {
    ...
    fn test_basic_subtraction() {
        ...
        for (a, b, expected) in tests {
            ...
            let result_fixed = __lp_fixed32_sub(a_fixed, b_fixed);
    ...
    fn test_zero_handling() {
        ...
        assert_eq!(__lp_fixed32_sub(one, zero), one, "1 - 0 should be 1");
        assert_eq!(
            __lp_fixed32_sub(zero, one),
            float_to_fixed(-1.0),
            "0 - 1 should be -1"
        );
        assert_eq!(__lp_fixed32_sub(zero, zero), 0, "0 - 0 should be 0");
    }
    ...
    fn test_overflow_saturation() {
        ...
        let result = __lp_fixed32_sub(large_a, large_neg_b);
    ...
    fn test_underflow_saturation() {
        ...
        let result = __lp_fixed32_sub(large_neg_a, large_b);
