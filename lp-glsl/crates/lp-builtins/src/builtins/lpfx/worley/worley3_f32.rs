...
#[lpfx_impl_macro::lpfx_impl(f32, "float lpfx_worley3(vec3 p, uint seed)")]
#[unsafe(no_mangle)]
pub extern "C" fn __lpfx_worley3_f32(x: f32, y: f32, z: f32, seed: u32) -> f32 {
    ...
    let result_fixed =
        __lpfx_worley3_q32(x_q32.to_fixed(), y_q32.to_fixed(), z_q32.to_fixed(), seed);
