...
//! # GLSL Usage
//!
//! This function is callable from GLSL shaders using the `lpfx_worley3` name:
//!
//! ```glsl
//! float noise = lpfx_worley3(vec3(5.0, 3.0, 1.0), 123u);
//! ```
//!
//! # Parameters
//!
...
#[lpfx_impl_macro::lpfx_impl(q32, "float lpfx_worley3(vec3 p, uint seed)")]
#[unsafe(no_mangle)]
