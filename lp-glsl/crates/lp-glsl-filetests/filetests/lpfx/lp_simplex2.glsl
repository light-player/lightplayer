...
// ============================================================================
// lpfx_snoise2(): 2D Simplex noise function
// ============================================================================
...
float test_lpfx_snoise2_deterministic() {
    ...
    vec2 p = vec2(0.5, 0.5);
    float n1 = lpfx_snoise2(p, 0u);
    float n2 = lpfx_snoise2(p, 0u);
    return abs(n1 - n2);
}
...
float test_lpfx_snoise2_different_seeds() {
    ...
    float diff1 = abs(lpfx_snoise2(vec2(0.5, 0.5), 0u) - lpfx_snoise2(vec2(0.5, 0.5), 1u));
    float diff2 = abs(lpfx_snoise2(vec2(1.5, 1.5), 0u) - lpfx_snoise2(vec2(1.5, 1.5), 1u));
    float diff3 = abs(lpfx_snoise2(vec2(2.5, 2.5), 0u) - lpfx_snoise2(vec2(2.5, 2.5), 1u));
    float diff4 = abs(lpfx_snoise2(vec2(3.5, 3.5), 0u) - lpfx_snoise2(vec2(3.5, 3.5), 1u));
    float diff5 = abs(lpfx_snoise2(vec2(4.5, 4.5), 0u) - lpfx_snoise2(vec2(4.5, 4.5), 1u));
...
float test_lpfx_snoise2_different_positions() {
    ...
    float n1 = lpfx_snoise2(vec2(0.0, 0.0), 0u);
    float n2 = lpfx_snoise2(vec2(1.0, 1.0), 0u);
...
float test_lpfx_snoise2_range() {
    ...
    float n1 = lpfx_snoise2(vec2(0.0, 0.0), 0u);
    float n2 = lpfx_snoise2(vec2(1.0, 0.0), 0u);
    float n3 = lpfx_snoise2(vec2(0.0, 1.0), 0u);
    float n4 = lpfx_snoise2(vec2(10.0, 10.0), 0u);
