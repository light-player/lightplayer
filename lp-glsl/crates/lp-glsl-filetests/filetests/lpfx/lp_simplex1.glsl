...
// ============================================================================
// lpfx_snoise1(): 1D Simplex noise function
// ============================================================================
...
float test_lpfx_snoise1_deterministic() {
    ...
    float n1 = lpfx_snoise1(0.5, 0u);
    float n2 = lpfx_snoise1(0.5, 0u);
    return abs(n1 - n2);
}
...
float test_lpfx_snoise1_different_seeds() {
    ...
    float diff1 = abs(lpfx_snoise1(0.5, 0u) - lpfx_snoise1(0.5, 1u));
    float diff2 = abs(lpfx_snoise1(1.5, 0u) - lpfx_snoise1(1.5, 1u));
    float diff3 = abs(lpfx_snoise1(2.5, 0u) - lpfx_snoise1(2.5, 1u));
    float diff4 = abs(lpfx_snoise1(3.5, 0u) - lpfx_snoise1(3.5, 1u));
    float diff5 = abs(lpfx_snoise1(4.5, 0u) - lpfx_snoise1(4.5, 1u));
...
float test_lpfx_snoise1_range() {
    ...
    float n1 = lpfx_snoise1(0.0, 0u);
    float n2 = lpfx_snoise1(1.0, 0u);
    float n3 = lpfx_snoise1(2.0, 0u);
    float n4 = lpfx_snoise1(10.0, 0u);
