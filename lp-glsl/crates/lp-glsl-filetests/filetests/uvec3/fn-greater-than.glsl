...
bvec3 test_uvec3_greater_than_mixed() {
    ...
    uvec3 a = uvec3(7u, 6u, 4u);
    uvec3 b = uvec3(5u, 8u, 3u);
...
bvec3 test_uvec3_greater_than_variables() {
    uvec3 a = uvec3(12u, 10u, 12u);
    uvec3 b = uvec3(10u, 15u, 8u);
    return greaterThan(a, b);
}

// run: test_uvec3_greater_than_variables() == bvec3(true, false, true)

bvec3 test_uvec3_greater_than_expressions() {
    return greaterThan(uvec3(5u, 5u, 4u), uvec3(3u, 7u, 2u));
}

// run: test_uvec3_greater_than_expressions() == bvec3(true, false, true)

bool test_uvec3_greater_than_in_expression() {
    uvec3 a = uvec3(3u, 7u, 1u);
    uvec3 b = uvec3(2u, 3u, 4u);
    uvec3 c = uvec3(1u, 5u, 3u);
    return greaterThan(a, b) == greaterThan(b, c);
    // (true,true,false) == (true,false,true) = false
}

// run: test_uvec3_greater_than_in_expression() == false
