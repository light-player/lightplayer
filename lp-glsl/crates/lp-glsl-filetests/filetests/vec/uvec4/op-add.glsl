...
uvec4 test_uvec4_add_positive_zero() {
    uvec4 a = uvec4(10u, 8u, 5u, 3u);
    uvec4 b = uvec4(0u, 0u, 0u, 0u);
    return a + b;
}

// run: test_uvec4_add_positive_zero() == uvec4(10u, 8u, 5u, 3u)
...
uvec4 test_uvec4_add_mixed_components() {
    uvec4 a = uvec4(100u, 50u, 25u, 10u);
    uvec4 b = uvec4(200u, 75u, 50u, 20u);
    return a + b;
}

// run: test_uvec4_add_mixed_components() == uvec4(300u, 125u, 75u, 30u)
