...
// run: test_uvec4_greater_equal_variables() == bvec4(true, false, true, false)

bvec4 test_uvec4_greater_equal_expressions() {
    return greaterThanEqual(uvec4(5u, 5u, 4u, 8u), uvec4(3u, 7u, 2u, 9u));
}

// run: test_uvec4_greater_equal_expressions() == bvec4(true, false, true, false)

bool test_uvec4_greater_equal_in_expression() {
...
// run: test_uvec4_greater_equal_in_expression() == false
