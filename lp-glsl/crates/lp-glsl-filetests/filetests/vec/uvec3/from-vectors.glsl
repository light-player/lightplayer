...
uvec3 test_uvec3_from_vectors_expressions() {
    return uvec3(uvec2(10u, 5u) + uvec2(5u, 10u), 15u);
}

// run: test_uvec3_from_vectors_expressions() == uvec3(15u, 15u, 15u)

uvec3 test_uvec3_from_vectors_other_combination() {
    return uvec3(99u, uvec2(50u, 75u) * uvec2(2u, 1u));
}

// run: test_uvec3_from_vectors_other_combination() == uvec3(99u, 100u, 75u)

uvec3 test_uvec3_from_vectors_in_assignment() {
    uvec3 result;
...
// run: test_uvec3_from_vectors_in_assignment() == uvec3(25u, 50u, 75u)

uvec3 test_uvec3_from_vectors_variables() {
    uvec2 vec_part = uvec2(123u, 456u);
    uint scalar_part = 789u;
    return uvec3(vec_part, scalar_part);
}

// run: test_uvec3_from_vectors_variables() == uvec3(123u, 456u, 789u)
