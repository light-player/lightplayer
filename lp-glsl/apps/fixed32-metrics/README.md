...
Tool for tracking fixed32 transform bloat metrics by generating detailed before/after reports for GLSL test files.
...
- `--format <format>` - Fixed point format: `Fixed16x16` or `Fixed32x32` (default: `Fixed16x16`)
...
Test GLSL files should be placed in the `glsl/` directory. Each file should contain a `main()` function.
