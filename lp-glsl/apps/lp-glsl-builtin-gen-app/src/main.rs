...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let builtins_dir = workspace_root.join("lp-glsl/crates/lp-glsl-builtins/src/builtins");
    ...
    let builtin_refs_path =
        workspace_root.join("lp-glsl/apps/lp-glsl-builtins-emu-app/src/builtin_refs.rs");
    ...
    let q32_builtins: Vec<BuiltinInfo> = builtins
        ...
        .collect();
    let mod_rs_path =
        workspace_root.join("lp-glsl/crates/lp-glsl-builtins/src/builtins/q32/mod.rs");
