...
Run the fixed generator to regenerate the builtin registry with correct `BuiltinId` variant names that match `LpLibFn::builtin_id()` expectations.
...
- `BuiltinId::LpSimplex3.name()` should return `"__lp_q32_lpfx_simplex3"`
...
- `BuiltinId::LpSimplex3` should map to `q32::__lp_q32_lpfx_simplex3`
