...
Create `worley2_q32.rs` implementing 2D Worley noise that returns the euclidean squared distance to the nearest feature point.

## Implementation

### Files to Create

1. **`lp-builtins/src/builtins/lpfx/worley/worley2_q32.rs`**
