...
Review existing out/inout parameter tests and add additional test cases for edge cases and array support.

## Implementation

### Files to Review

1. **`lp-glsl/crates/lp-glsl-filetests/filetests/function/param-out.glsl`**
2. **`lp-glsl/crates/lp-glsl-filetests/filetests/function/param-inout.glsl`**
3. **`lp-glsl/crates/lp-glsl-filetests/filetests/function/param-mixed.glsl`**
4. **`lp-glsl/crates/lp-glsl-filetests/filetests/function/edge-lvalue-out.glsl`**
