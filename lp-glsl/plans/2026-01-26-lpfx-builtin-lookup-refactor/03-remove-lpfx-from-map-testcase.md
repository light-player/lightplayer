...
Update the codegen tool to stop generating LPFX function entries in `map_testcase_to_builtin`. LPFX functions are now handled via the proper lookup chain.

## Implementation

1. Update `lp-glsl/apps/lp-builtin-gen/src/main.rs`:
