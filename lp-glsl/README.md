...
`lp-glsl` is the shader compiler for **LightPlayer** — a system that JIT-compiles GLSL shaders to
...
- `lp-glsl-core/`, `lp-glsl-diagnostics/`, `lp-glsl-values/` — shared types and errors for
  tests / exec helpers
