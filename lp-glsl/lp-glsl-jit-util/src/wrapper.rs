...
/// interface to StructReturn functions. The main `lp-glsl-cranelift` crate uses the lower-level
...
///
/// # Note
/// This function is provided as a convenience API. The main `lp-glsl-cranelift` crate uses
